...
static const _SpeechText_Event_type_support_symbol_names_t _SpeechText_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autopatrol_interfaces, srv, SpeechText_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autopatrol_interfaces, srv, SpeechText_Event)),
  }
};
...
{
  return &::autopatrol_interfaces::srv::rosidl_typesupport_cpp::SpeechText_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autopatrol_interfaces, srv, SpeechText_Event)() {
  return get_message_type_support_handle<autopatrol_interfaces::srv::SpeechText_Event>();
}
...
static const rosidl_service_type_support_t SpeechText_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<autopatrol_interfaces::srv::SpeechText_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<autopatrol_interfaces::srv::SpeechText_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<autopatrol_interfaces::srv::SpeechText_Event>(),
