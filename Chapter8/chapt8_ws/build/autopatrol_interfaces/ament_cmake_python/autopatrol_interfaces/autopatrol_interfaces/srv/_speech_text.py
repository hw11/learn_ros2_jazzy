...
class Metaclass_SpeechText_Event(type):
    """Metaclass of message 'SpeechText_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__speech_text__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__speech_text__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__speech_text__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__speech_text__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__speech_text__event
...
class SpeechText_Event(metaclass=Metaclass_SpeechText_Event):
    """Message class 'SpeechText_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<autopatrol_interfaces/SpeechText_Request, 1>',
        'response': 'sequence<autopatrol_interfaces/SpeechText_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['autopatrol_interfaces', 'srv'], 'SpeechText_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['autopatrol_interfaces', 'srv'], 'SpeechText_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from autopatrol_interfaces.srv import SpeechText_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SpeechText_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SpeechText_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from autopatrol_interfaces.srv import SpeechText_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SpeechText_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SpeechText_Response'"
...
class Metaclass_SpeechText(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _speech_text.Metaclass_SpeechText_Event._TYPE_SUPPORT is None:
                _speech_text.Metaclass_SpeechText_Event.__import_type_support__()
...
class SpeechText(metaclass=Metaclass_SpeechText):
    ...
    from autopatrol_interfaces.srv._speech_text import SpeechText_Event as Event
