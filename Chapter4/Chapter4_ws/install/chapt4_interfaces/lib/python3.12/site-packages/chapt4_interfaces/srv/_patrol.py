...
class Metaclass_Patrol_Event(type):
    """Metaclass of message 'Patrol_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__patrol__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__patrol__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__patrol__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__patrol__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__patrol__event
...
class Patrol_Event(metaclass=Metaclass_Patrol_Event):
    """Message class 'Patrol_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<chapt4_interfaces/Patrol_Request, 1>',
        'response': 'sequence<chapt4_interfaces/Patrol_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['chapt4_interfaces', 'srv'], 'Patrol_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['chapt4_interfaces', 'srv'], 'Patrol_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from chapt4_interfaces.srv import Patrol_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, Patrol_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Patrol_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from chapt4_interfaces.srv import Patrol_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Patrol_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Patrol_Response'"
...
class Metaclass_Patrol(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _patrol.Metaclass_Patrol_Event._TYPE_SUPPORT is None:
                _patrol.Metaclass_Patrol_Event.__import_type_support__()
...
class Patrol(metaclass=Metaclass_Patrol):
    ...
    from chapt4_interfaces.srv._patrol import Patrol_Event as Event
