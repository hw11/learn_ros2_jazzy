...
static const _SpeechText_Request_type_support_symbol_names_t _SpeechText_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopatrol_interfaces, srv, SpeechText_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autopatrol_interfaces, srv, SpeechText_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autopatrol_interfaces, srv, SpeechText_Request)() {
  return &::autopatrol_interfaces::srv::rosidl_typesupport_c::SpeechText_Request_message_type_support_handle;
}
...
static const _SpeechText_Response_type_support_symbol_names_t _SpeechText_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopatrol_interfaces, srv, SpeechText_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autopatrol_interfaces, srv, SpeechText_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autopatrol_interfaces, srv, SpeechText_Response)() {
  return &::autopatrol_interfaces::srv::rosidl_typesupport_c::SpeechText_Response_message_type_support_handle;
}
...
typedef struct _SpeechText_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _SpeechText_Event_type_support_ids_t;

static const _SpeechText_Event_type_support_ids_t _SpeechText_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_c",  // ::rosidl_typesupport_fastrtps_c::typesupport_identifier,
    "rosidl_typesupport_introspection_c",  // ::rosidl_typesupport_introspection_c::typesupport_identifier,
  }
...
typedef struct _SpeechText_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _SpeechText_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _SpeechText_Event_type_support_symbol_names_t _SpeechText_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopatrol_interfaces, srv, SpeechText_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autopatrol_interfaces, srv, SpeechText_Event)),
  }
};

typedef struct _SpeechText_Event_type_support_data_t
{
  void * data[2];
} _SpeechText_Event_type_support_data_t;

static _SpeechText_Event_type_support_data_t _SpeechText_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _SpeechText_Event_message_typesupport_map = {
  2,
  "autopatrol_interfaces",
  &_SpeechText_Event_message_typesupport_ids.typesupport_identifier[0],
  &_SpeechText_Event_message_typesupport_symbol_names.symbol_name[0],
  &_SpeechText_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t SpeechText_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_SpeechText_Event_message_typesupport_map),
  rosidl_typesupport_c__get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autopatrol_interfaces, srv, SpeechText_Event)() {
  return &::autopatrol_interfaces::srv::rosidl_typesupport_c::SpeechText_Event_message_type_support_handle;
}
...
static const _SpeechText_type_support_symbol_names_t _SpeechText_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autopatrol_interfaces, srv, SpeechText)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autopatrol_interfaces, srv, SpeechText)),
  }
};
...
static const rosidl_service_type_support_t SpeechText_service_type_support_handle = {
  ...
  &SpeechText_Request_message_type_support_handle,
  &SpeechText_Response_message_type_support_handle,
  &SpeechText_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, autopatrol_interfaces, srv, SpeechText)() {
  return &::autopatrol_interfaces::srv::rosidl_typesupport_c::SpeechText_service_type_support_handle;
}
